...
-- Проверка на инжектор (Synapse X, Krnl и т.д.)
...
screenGui.Parent = game:GetService("CoreGui") -- Используем CoreGui для инжектора
...
homeLabel.Text = "Cyberpunk Injector Menu v2.0"
...
executeButton.TextColor3 = Color3.fromRGB(0, 255, 255)
...
executeStroke.Color = Color3.fromRGB(0, 255, 255)
...
local function handleInput(input, isDragging)
...
-- Альтернативная обработка ввода для инжекторов
if isInjector then
